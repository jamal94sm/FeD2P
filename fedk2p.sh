...
python main1.py --local_model_name "ResNet20" --num_train_samples 50000 --alpha_dirichlet 1 --output_name "ResNet20_50K_alpha1_"  	# this is the direction and the name of your code
#python openVocab.py
