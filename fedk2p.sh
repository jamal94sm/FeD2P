...
#SBATCH --time=24:00:00 		   # time period you need for your code (it is 12 hours for example)
...
python main1.py --alpha_dirichlet 100 --output_name "alpha100_"  	# this is the direction and the name of your code
#python openVocab.py
