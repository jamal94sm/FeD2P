...
#SBATCH --time=020:00:00 		   # time period you need for your code (it is 12 hours for example)
...
python main.py --alpha_dirichlet 0.01   	# this is the direction and the name of your code
