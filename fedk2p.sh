...
python main1.py --local_model_name "ResNet20" --num_train_samples 5000 --alpha_dirichlet 10 --output_name "ResNet20_5K_alpha10_"  	# this is the direction and the name of your code
#python openVocab.py
