...
def get_args():
    ...
    parser.add_argument('--output_name', type=str, default='_ResNet18_Fashion_2K_alpha10_')
    
    parser.add_argument('--local_model_name', type=str, default="ResNet10")
    parser.add_argument('--dataset', type=str, default="fashion_mnist") # fashion_mnist, cifar10

    parser.add_argument('--num_clients', type=int, default= 10)
    parser.add_argument('--rounds', type=int, default=30)
    
    parser.add_argument('--num_train_samples', type=int, default=2_000)
    parser.add_argument('--num_test_samples', type=int, default=200)
    parser.add_argument('--num_public_samples', type=int, default=200)
    parser.add_argument('--num_synth_img_per_class', type=int, default=20)
