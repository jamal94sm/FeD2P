...
def get_args():
    ...
    parser.add_argument('--output_name', type=str, default='_ResNet18_Fashion_5K_alpha10_')
    ...
    parser.add_argument('--num_public_samples', type=int, default=500)
    parser.add_argument('--num_synth_img_per_class', type=int, default=50)
